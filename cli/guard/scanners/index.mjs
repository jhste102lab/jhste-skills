...
import { scanDependencyBoundaryAdvisory, scanExtensionBoundaryAdvisory } from './solid-design.mjs';
...
export const SCANNER_REGISTRY = [
  ...
  { id: 'scanExtensionBoundaryAdvisory', families: ['extension_seam_advisory'], scan: ({ relPath, text }) => scanExtensionBoundaryAdvisory(relPath, text) },
