...
- default setup does not modify CI, target `package.json`, or lockfiles; it may install a managed advisory git hook unless `--skip-hooks` is used, and it refuses to overwrite non-managed hooks;
