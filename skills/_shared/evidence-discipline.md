...
Single source of truth for proof/evidence discipline across the jhste skills. Cited by `jhste-engineering-groundwork` (pre-change) and `jhste-red-team-review` (post-change).
