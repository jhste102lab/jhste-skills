...
- Which SOLID-informed question is actually relevant? Apply the shared lens in `../../_shared/solid-lens.md` rather than restating it here.
...
### SOLID-informed review

For the SRP/OCP/LSP/ISP/DIP bad/better/why skeletons, use the shared lens in `../../_shared/solid-lens.md`. Do not restate them here.
