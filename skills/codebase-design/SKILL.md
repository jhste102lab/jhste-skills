...
Use these terms as the internal review lens; when repo-local docs already use different terms, map this vocabulary to the repo-local terms instead of renaming established concepts. Avoid substituting generic "component," "service," "API," or "boundary" when no local term exists.
