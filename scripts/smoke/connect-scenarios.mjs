...
export function runConnectScenarios({ root, tmp, skillsDir }) {
  ...
  if (skillDirs(nonGitCwdSkills).length !== 23) fail('install outside git repo did not install 23 bundled skills');
  ...
  if (skillDirs(connectMissingSkills).length !== 23) fail('connect --install-missing did not install 23 bundled skills');
