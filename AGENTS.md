...
4. Before declaring non-trivial code work complete, use the `jhste-final-review` skill.
5. Skip final review for docs-only, comment-only, formatting-only, and trivial rename-only changes.
